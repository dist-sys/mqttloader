...
public class PublisherV5 extends AbstractPublisher {
    ...
    public PublisherV5(int clientNumber, String broker, String userName, String password, String trustStore, String keyStore, int qos, boolean retain, String topic, int payloadSize, int numMessage, int pubInterval, Recorder recorder) {
